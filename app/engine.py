...
class QueryIntent:
    ...
    # 模块能力标签
    MODULE_PROFILES = {
        "searxng":   {"types": {"general", "news", "image", "video"}, "langs": {"zh", "en"}, "speed": "fast", "quality": 0.8},
        "metaso":    {"types": {"general", "research", "academic"}, "langs": {"zh"}, "speed": "slow", "quality": 0.95},
        "phind":     {"types": {"code", "tech"}, "langs": {"en", "zh"}, "speed": "slow", "quality": 0.9},
        "tabbit":    {"types": {"general", "research"}, "langs": {"zh", "en"}, "speed": "medium", "quality": 0.85},
        "web":       {"types": {"general"}, "langs": {"en", "zh"}, "speed": "fast", "quality": 0.7},
        "jina":      {"types": {"content"}, "langs": {"en", "zh"}, "speed": "medium", "quality": 0.8},
        "github":    {"types": {"code", "tech", "repo"}, "langs": {"en"}, "speed": "fast", "quality": 0.85},
        "pdf":       {"types": {"pdf", "doc"}, "langs": {"en", "zh"}, "speed": "medium", "quality": 0.75},
        "docs":      {"types": {"doc", "tech"}, "langs": {"en"}, "speed": "medium", "quality": 0.75},
        "academic":  {"types": {"academic", "research", "paper"}, "langs": {"en"}, "speed": "fast", "quality": 0.85},
        "wiki":      {"types": {"knowledge", "general"}, "langs": {"zh", "en"}, "speed": "fast", "quality": 0.8},
        "brave":     {"types": {"general"}, "langs": {"en"}, "speed": "fast", "quality": 0.8},
        "tavily":    {"types": {"general", "research"}, "langs": {"en"}, "speed": "fast", "quality": 0.85},
        "serper":    {"types": {"general"}, "langs": {"en", "zh"}, "speed": "fast", "quality": 0.8},
    }
    ...
    @classmethod
    def select_modules(cls, intent: dict, available: dict[str, BaseSearchModule]) -> list[str]:
...
class ResultMerger:
    ...
    AUTHORITY_DOMAINS = {
        ...
        "baike.baidu.com", "zhihu.com", "csdn.net",
    ...
    def rerank(cls, results: list[SearchResult]) -> list[SearchResult]:
        ...
        for r in results:
            ...
            # 模块权重
            source = r.metadata.get("engine_primary", r.source) if r.metadata else r.source
...
class SearchEngine:
    ...
    async def search(self, request: SearchRequest) -> SearchResponse:
        ...
        response = SearchResponse(
            ...
            errors=errors,
            metadata={"intent": {"types": list(intent["types"]), "hints": list(intent["hints"])}},
        )
