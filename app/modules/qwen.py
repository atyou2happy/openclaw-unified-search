"""Qwen AI 搜索（CDP） — 使用 cdp_pool 统一连接管理"""
...
class QwenModule(BaseSearchModule):
    name = "qwen"
    description = "Qwen AI 搜索（CDP）"
    URL = "https://chat.qwen.ai/?inputFeature=search"
